    ...
    <style>
        ...
        @keyframes breathe {
            ...
            50% { 
                ...
                box-shadow: 0 0 50px rgba(14, 165, 233, 0.8), 0 0 80px rgba(139, 92, 246, 0.4);
            }
        }
...
<ul class="sidebar-menu" style="padding: 20px 0; flex: 1; overflow-y: auto;">
            ...
            <?php if (isAdmin()): ?>
                <li class="admin-menu-item">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="index.php#youtube-dashboard"><i class="fab fa-youtube"></i> YouTube Stats</a></left></li>
                    </ul>
                </li>
            <?php endif; ?>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <!-- Welcome Banner with Enhanced Profile Image -->
            <div class="user-welcome reveal" style="text-align: center; padding: 40px; background: var(--glass); backdrop-filter: blur(20px); border-radius: var(--radius); border: 1px solid var(--glass-border); margin-bottom: 40px;">
                <!-- Enhanced Profile Image with Multiple Rings -->
            ...
            <div class="card-grid reveal">
                <div class="card">
                    ...
                    <h3>My Profile</h3>
                    <p>View and edit your profile information, update your photo and details.</p>
                ...
                <div class="card">
                    ...
                    <h3>Settings</h3>
                    <p>Manage your account settings, change password, and customize theme.</p>
                ...
                <div class="card">
                    <span class="tool-icon">📧</span>
                    <h3>Contact Admin</h3>
                    <p>Send messages to the website administrator directly.</p>
                ...
                <div class="card" style="border-color: var(--primary);">
                    <span class="tool-icon">🛡️</span>
                    <h3>Admin Panel</h3>
                    <p>Manage users, content, engagement analytics, and site settings.</p>
                    <a href="admin.php" class="btn-download" style="background: var(--primary);">Admin Panel</a>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="card reveal" style="max-width: 700px; margin: 0 auto; padding: 35px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        <label style="font-size: 12px; text-transform: uppercase; letter-spacing: 1px; color: var(--text-muted); margin-bottom: 8px;">District</label>
                        <div style="padding: 14px 16px; background: var(--bg-darker); border: 1px solid var(--border); border-radius: var(--radius-sm); color: var(--text-primary); font-size: 15px; font-weight: 500;">
                            <?php echo htmlspecialchars(ucfirst($user['district'] ?? 'Not set')); ?>
                        </div>
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 0;">
                        <label style="font-size: 12px; text-transform: uppercase; letter-spacing: 1px; color: var(--text-muted); margin-bottom: 8px;">Member Since</label>
                        <div style="padding: 14px 16px; background: var(--bg-darker); border: 1px solid var(--border); border-radius: var(--radius-sm); color: var(--text-primary); font-size: 15px; font-weight: 500;">
                            <?php echo htmlspecialchars($user['created_at'] ?? 'Unknown'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 20px;">
                    <label style="font-size: 12px; text-transform: uppercase; letter-spacing: 1px; color: var(--text-muted); margin-bottom: 12px; display: block;">Skills</label>
                    <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                        <?php 
                        $skills = explode(',', $user['skills']);
                        foreach ($skills as $skill) {
                            echo '<span style="padding: 8px 16px; background: linear-gradient(135deg, var(--primary), var(--accent)); color: white; border-radius: 25px; font-size: 13px; font-weight: 600;">' . htmlspecialchars(trim($skill)) . '</span>';
                        }
                        ?>
                    </div>
                </div>
